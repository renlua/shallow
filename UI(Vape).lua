...
local Shallow = {}
Shallow.BackgroundTransparency = 0.5
...
function library:new(text, preset, closebind)
	...
	DropShadow.ZIndex = 0
	DropShadow.Image = "rbxassetid://18634439245"
	DropShadow.ImageColor3 = Color3.fromRGB(29, 29, 29)
	DropShadow.ImageTransparency = 0.350
    ...
    Title.Position = UDim2.new(0.42, 0, 0.04, 0)
    ...
    function tabhold:Tab(text,icon)
        ...
        function tabcontent:Button(text, callback)
            ...
            Button.BackgroundTransparency = Shallow.BackgroundTransparency
        ...
        function tabcontent:Toggle(text,flag,default, callback)
            local toggled = false
            ...
            Toggle.BackgroundTransparency = Shallow.BackgroundTransparency
       ...
       function tabcontent:Slider(text, min, max, start, callback)
            ...
            Slider.Text = ""
            Slider.BackgroundTransparency = Shallow.BackgroundTransparency
        ...
        function tabcontent:Dropdown(text,flag, list, callback)
            local droptog = false
            local framesize = 0
            local itemcount = 0
            ...
            Dropdown.BackgroundTransparency = Shallow.BackgroundTransparency
            Dropdown.Parent = Tab
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            Colorpicker.BackgroundTransparency = Shallow.BackgroundTransparency
        ...
        function tabcontent:Label(text)
            ...
            Label.Name = "Button"
            Label.Parent = Tab
            Label.BackgroundTransparency = Shallow.BackgroundTransparency
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            Textbox.Parent = Tab
            Textbox.BackgroundTransparency = Shallow.BackgroundTransparency
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            Bind.BackgroundTransparency = Shallow.BackgroundTransparency
