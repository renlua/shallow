...
onof.MouseButton1Down:connect(function()
	if nowe == true then
		...
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.FallingDown, true)
		...
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.GettingUp, true)
		...
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.PlatformStanding, true)
		...
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.RunningNoPhysics, true)
		game:GetService("Players").LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Seated, true)
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.StrafingNoPhysics, true)
		game:GetService("Players").LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Swimming, true)
		game:GetService("Players").LocalPlayer.Character.Humanoid:ChangeState(Enum.HumanoidStateType.RunningNoPhysics)
	else
		nowe = true
		for i = 1, speeds do
			spawn(function()
				...
				while
					tpwalking
					and game:GetService("RunService").Heartbeat:Wait()
		...
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.Freefall, false)
		game:GetService("Players").LocalPlayer.Character.Humanoid
		...
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.PlatformStanding, false)
		...
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.RunningNoPhysics, false)
		game:GetService("Players").LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Seated, false)
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.StrafingNoPhysics, false)
		game:GetService("Players").LocalPlayer.Character.Humanoid
			:SetStateEnabled(Enum.HumanoidStateType.Swimming, false)
